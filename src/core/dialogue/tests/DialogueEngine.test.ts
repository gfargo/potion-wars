...
test('handleChoice applies effects correctly', (t) => {
  ...
  const result = DialogueEngine.handleChoice(
    choice,
    mockGameState,
    'Market Square'
  )
...
test('evaluateConditions works with different condition types', (t) => {
  ...
  const result = DialogueEngine.evaluateConditions(
    conditions,
    mockGameState,
    'Market Square'
  )
...
test('applyEffects handles inventory changes correctly', (t) => {
  ...
  const result = DialogueEngine.applyEffects(
    effects,
    mockGameState,
    'Market Square'
  )
    ...
    dialogue: {
      ...
      nodes: {
        greeting: {
          id: 'greeting',
          text: 'Hello',
          choices: [{ text: 'Go to missing node', nextNode: 'missing' }],
        },
      },
    },
  }
    ...
    dialogue: {
      ...
      nodes: {
        greeting: {
          id: 'greeting',
          text: '',
          choices: [{ text: 'Test', nextNode: undefined }],
        },
      },
    },
  }
