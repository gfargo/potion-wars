...
const AsciiAnimationComponent = React.forwardRef<AsciiAnimationControls, AsciiAnimationProperties>(({
  frames,
  speed = 500,
  isLooping = true,
  loopCount = Infinity,
  ...
  }, [frames, isLooping, loopCount, loopDuration, iteration, onComplete, isPlaying, isCompleted])
...
export interface AsciiAnimationControls {
  start: () => void
  pause: () => void
  stop: () => void
  reset: () => void
